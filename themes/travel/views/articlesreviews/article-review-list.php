...
<div id="main" class="site-main container_16">
  ...
  <ul class="TabbedPanelsTabGroup">
    <li class="TabbedPanelsTab tabsrr-active"><a href="<?php echo Yii::app()->createUrl('articlesreviews/list')?>" class="active"><?php echo t('Articles'); ?></a></li>
    <li class="TabbedPanelsTab"><a href="<?php echo Yii::app()->createUrl('articlesreviews/review-list')?>"><?php echo t('Reviews'); ?></a></li>
  </ul>
  <div class="TabbedPanelsContentGroup">
    <div class="TabbedPanelsContent"><?php foreach ( $Contributemyarticle as $Contributemyarticles) { ?>
                  <div class="temple_contribute">
                    ...
                    <p><em><img alt="" src="<?php echo $layout_asset; ?><?php echo Contributemyarticle::GetThumbnail($Contributemyarticles); ?>"></em><?php echo $Contributemyarticles->content1 ; ?></p>
                    <a href="<?php echo Yii::app()->createUrl('articlesreviews/articleread',array('aid'=>$Contributemyarticles->id)); ?>" class="read">Read More</a> </div>
                  <?php } ?>
