          ...
          <div class="theme-god">
            <div class="TabbedPanels">
              <ul class="TabbedPanelsTabGroup">
                <li class="TabbedPanelsTab"><a href="<?php echo Yii::app()->createUrl('articles')?>"><?php echo t('Articles'); ?></a></li>
                <li class="TabbedPanelsTab tabsrr-active"><a href="<?php echo Yii::app()->createUrl('reviews')?>" class="active"><?php echo t('Reviews'); ?></a></li>
              </ul>
                ...
                <div class="TabbedPanelsContent">
                  ...
                  <div class="temple_contribute">
                    ...
                    <div class="article_date_time pad20">
                      <ul>
                      	 <li><span> Rate by, <strong><?php echo $Writeyourreview->name; ?></strong>.</span></li>
                     ...
                     <?php $avg = (int) ( $Writeyourreview->divine_power + $Writeyourreview->popularity + $Writeyourreview->accessibility + $Writeyourreview->facility_food + $Writeyourreview->cleanliness ) % 5; ?>
                    
                    <p> <?php if($avg!=0) { ?> <span> <img alt="Ratings" src="<?php echo $layout_asset; ?>/images/rating/<?php echo $avg; ?>.png"> </span> <?php } ?> </p>
