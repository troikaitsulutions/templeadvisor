            ...
            <div class="details">
                  ...
                  <div class="time">
                    ...
                    <div class="landing">
                      ...
                      <div class="timing"> <span class="wine-color">Pooja(s)</span><br />
                        4 Available<br />
                        <a class="button btn-mini yellow">Book Now</a> </div>
                    </div>
                  </div>
                  <div class="action"> <a class="button btn-small" href="<?php echo Yii::app()->createUrl('temples/detail',array('country'=>'temples-in-india', 'religion' => $ReligionSeo->slug, 'tid' => $TempleSeo->slug));?>" >VIEW DETAIL</a> <a class="button btn-small yellow" href="#">Book A Trip</a> </div>
			</div>
    </article>
</div>