  ...
  <div class="tmp_description">
	...
	$c = new CDbCriteria();
       // $c->select = 'id, name, SQRT(latitude-'.$lati.')+SQRT(longitude-'.$longi.') AS GPSList';
		...
		$c->select = 'id, name, town, district, state, type, comment, ( 3959 * acos( cos( radians('.$lati.') ) 
    ...
    <div class="places">
      ...
      <ul>
        ...
        <li class="tip"><a><?php echo $NearT->name; ?></a>
          <p class="tooltipL"><strong><?php echo $NearT->name; ?></strong> <br>
            ---------------------<br>
            <span><?php echo $NearT->comment; ?></span></p>
        </li>
        <?php } } ?>
      </ul>
      ...
      <div class="hide-content">
        <ul>
          ...
          <li class="border-bottom padding-tb tmp_description_li">
            ...
            <div class="loc"><?php echo $NearT->name.', '.Town::GetName($NearT->town).', '.District::GetName($NearT->district).', '.State::GetName($NearT->state); ?></div>
            
            <!--<div class="loc"> <?php echo $NearT->comment; ?> </div> --> 
          </li>
          <?php } } ?>
        </ul>
      </div>
