<?php
	...
	$js_ret = 'jQuery("#GetMyFilter").click(function() {
	   ...
	   if(allVals != "") { params +="&deities="+allVals; }
	   window.location.replace("'.Yii::app()->createUrl('temples/bytheme').'"+params);
	});';
              ...
              <div class="resp-tab-content resp-tab-content-active" aria-labelledby="tab_item-0" style="display:block"> 
                <!--  <div class="temple-menu-count">
                  <div class="temple-menu-rr">
                    <ul>
                      <li><a href="<?php echo Yii::app()->createUrl('temples/bytheme'); ?>" class="temple-menu-rr-active"><?php echo t('Hindu Deity'); ?></a></li>
               ...
               -->
                ...
                <div class="temple-list-count">
                  <div class="temple-list-count-left"><?php echo t('Listed Temples for the search of "'.$q.'"'); ?></div>
                  <div class="temple-list-count-right">Total No of Temples : <span id="total_temples"><?php echo $item_count; ?></span></div>
