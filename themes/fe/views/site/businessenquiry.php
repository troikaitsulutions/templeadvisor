           ...
           <?php $this->render('cmswidgets.views.notification'); ?>
            ...
            <div class="temple_contact_business">
                            ...
                            <p>
                            	...
                            	<span class="error"><?php echo $form->error($model,'companyname'); ?> </span>
                            </p>
                           <p>
                            	<?php echo $form->label($model,'city'); ?>
                            	<?php echo $form->textField($model,'city'); ?>
                            	<span class="error"><?php echo $form->error($model,'city'); ?> </span>
                            </p>
                             <p>
                            	<?php echo $form->label($model,'state'); ?>
                            	<?php echo $form->dropDownList($model,'state', State::GetAll(), array()); ?>
                            	<span class="error"><?php echo $form->error($model,'state'); ?> </span>
                            </p>
                            <p>
                            	<?php echo $form->label($model,'nob'); ?>
                            	<?php echo $form->dropDownList($model,'nob',ConstantDefine::getNaturalOfBusiness(),array()); ?>
                            	<span class="error"><?php echo $form->error($model,'nob'); ?> </span>
                            </p>
                            <p>
                            ...
                            <p>
                            	<?php echo $form->label($model,'ep'); ?>
                            	<?php echo $form->dropDownList($model,'ep',ConstantDefine::getEnquiryPurpose(),array()); ?>
                            	<span class="error"><?php echo $form->error($model,'ep'); ?> </span>
                            </p>
                            <p>
                            	<?php echo $form->label($model,'comments'); ?>
                            	<?php echo $form->textArea($model, 'comments',array('rows' => 8, 'cols' => 32)); ?>
                            	<span class="error"><?php echo $form->error($model,'comments'); ?> </span>
                            </p>
                            <p>
                            	<label>&nbsp;</label>
