...
<div id="main" class="site-main container_16">
  <div class="inner clearfix">
    <div class="theme-slogan">
      <?php $this->renderPartial('//layouts/bcrumbs4',array('layout_asset'=>$layout_asset, 'meta'=>$meta )); ?>
      ...
      <div class="temple_content_left">
        <div class="tmp_region_right_testi">
          ...
          <div class="temple_image_section clearfix">
            <div class="user_article">
              <?php echo $Contributemyarticles->content1 ; ?>
            </div>
          </div>
          <div class="clr"></div>
        </div>
        ...
        <!--
                <div class="testi_realted">
                    ...
                    <ul>
                    	<li>
                        	<span><img src="<?php echo $layout_asset; ?>/images/realted01.jpg" alt="" /></span>
