...
class Diety extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('name', 'required'),
			array('id, crby, mod_by, created, modified, status, addtohome, mnu_order, temple_diety, pooja_diety', 'numerical', 'integerOnly'=>true),
			array('uid, name, cr_ip, mod_ip, icon_file', 'length', 'max'=>255),
	...
	public function attributeLabels()
	{
		return array(
			'id' => t('ID'),
			'name' => t('Diety Name'),
			'pooja_diety' => t('show this diety on pooja list'),
			'temple_diety' => t('show this diety on Temple list'),
			'content' => t('About Diety'),
			'comment' => t('Pooja Description'),
	...
	public static function GetRegionName(){
		...
		{               
	         if($data!='') { return 'http://temples.s3.amazonaws.com/diety/240x143/'.$data;  }
