...
class Alltemples extends CActiveRecord
{
	/**
	...
	public function search()
	{
		...
		$criteria->with = array('DietyName','TownName');
		$criteria->addSearchCondition('t.name', $q,true,'OR');
		//$criteria->compare('DietyName.name',$q,true);
		$criteria->addSearchCondition('DietyName.name', $q,true,'OR');
		$criteria->addSearchCondition('TownName.name', $q,true,'OR');
