...
class Booking extends CActiveRecord
{
	...
	public function search()
	{
		...
		$criteria->condition = "bsource = '1' AND customer_id != '1'";
		if((user()->isAgent) || (user()->isVillaOwner))
		{

			$user = User::model()->find(array('condition'=>"user_id='".user()->id."'"));
							$criteria->join='join tt_pinfo a on  t.prop_id=a.id';
							$criteria->compare('a.owner',$user->people_id);
		}
