 ...
 */
class Earlydiscount extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('lang, prop_id, value, dates', 'numerical', 'integerOnly'=>true),
	...
	public function search()
	{
		...
		$criteria->compare('lang',$this->lang);
                ...
                $sort = new CSort;
                $sort->attributes = array('id','dates','value');
	...
	public function searchByobject($object_id)
	{
		...
		//$criteria->compare('id',$this->id,true);
		$criteria->select='*, CONCAT (dates, "  days or more before check-in") as noofdays';
		$criteria->compare('name',$this->name,true);
