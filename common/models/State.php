...
class State extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('created, region, status, name', 'required'),
			array('lang, id, crby, region, mod_by, created, modified, status, source, addtohome', 'numerical', 'integerOnly'=>true),
