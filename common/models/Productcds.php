...
class Productcds extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('name, uid, cr_ip, mod_ip, singer, music_director, producer, icon_file, vendor_sku, vendor_product_name', 'length', 'max'=>255),
			array('crby, status, mod_by, created, modified, media_type, file_type, language, scategory, minorderqty, edition, height, width, depth, weight, vendor, featured, best_selling', 'numerical', 'integerOnly'=>false),
			array('icon_file', 'file', 'allowEmpty'=>true, 'types'=>'jpg, gif, png, jpeg','maxSize'=>1024*1024*5,'on'=>'update'),
			array('id, uid, status, name, tracklist', 'safe'),
		);
	}
	...
	protected function afterDelete()
	  ...
	  public static function GetThumbnail($data)
		{               
	         if($data!='') { return 'http://temples.s3.amazonaws.com/products/cds/240x143/'.$data;  }
