...
class Distancesdescriptiontype extends CActiveRecord
{
	/**
	...
	{
		return '{{distancesdescriptiontype}}';
	}
	...
	public function rules()
	{
		...
		return array(
			...
			array('lang, id, crby, created, modified, status, addtohome, comment_count, comment_status, rating_scores', 'numerical', 'integerOnly'=>true),
	...
	public function attributeLabels()
	{
		return array(
			'id' => t('ID'),
			'name' => t('Distances Description Type Name'),
			
			'content' => t('About Distances Description Type'),
