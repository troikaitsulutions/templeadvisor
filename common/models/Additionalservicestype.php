...
class Additionalservicestype extends CActiveRecord
{
	/**
	...
	public function attributeLabels()
	{
		return array(
			'id' => t('ID'),
			'name' => t('Additional Services Type Name'),
			
			'content' => t('About Additional Services'),
