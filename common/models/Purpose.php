...
class Purpose extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('name, comment, type', 'required'),
			array('id, crby, mod_by, created, modified, status, type', 'numerical', 'integerOnly'=>true),
	...
	{
		if( $this->type == 1 ) { return 'Pooja'; }
		if( $this->type == 2 ) { return 'Homam'; }
		if( $this->type == 3 ) { return 'Astrology'; }
	}
