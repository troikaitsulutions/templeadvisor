...
class Temples extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, name, uid, content1, religion, sdeity, deity', 'safe', 'on'=>'search'),
	...
	public function relations()
	{
		...
		// class name for the relations automatically generated below.
		 return array(                    
			...
			'ReligionName' => array(self::BELONGS_TO, 'Religion', 'religion'),
             ); 
	}
	...
	public function search()
	{
		...
		$criteria->compare('t.deity',$this->deity,true);
		$criteria->compare('t.sdeity',$this->sdeity,true);
		$criteria->compare('t.religion',$this->religion, true);
  ...
  if ($unit == "K") {
	...
	public function getEvents()
		{
			$EventList = Festivalevent::model()->findAll(array(
						'condition'=>'status = 1 AND temple = :TMP',
						'params'=>array(':TMP'=>$this->id )));
