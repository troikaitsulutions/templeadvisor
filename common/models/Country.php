...
class Country extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('name', 'required'),
			array('lang, id, crby, created, modified, crby, mod_by status, comment_count, comment_status, rating_scores, source', 'numerical', 'integerOnly'=>true),
			array('guid, uid, name', 'length', 'max'=>255),
			array('content', 'length', 'min'=>25),
			array('id, name, uid, lang, cr_ip, mod_ip', 'safe', 'on'=>'search'),
		);
	}
