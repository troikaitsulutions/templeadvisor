...
class Toursubcategory extends CActiveRecord
{
	/**
	...
	public static function GetThumbnail($data)
		{               
			 		...
			 		return 'http://temples.s3.amazonaws.com/tours/category/240x143/'.$data; 
    ...
    public static function GetAll($render=true){    
		...
		public static function GetTourtypeName(){
