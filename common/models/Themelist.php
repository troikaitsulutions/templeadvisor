...
class Themelist extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('lang, created, modified, status, name, source', 'required'),
			array('lang, id, crby, mod_by, created, modified, status, source, addtohome, mnu_order', 'numerical', 'integerOnly'=>true),
	...
	public function attributeLabels()
	{
		return array(
			'id' => t('ID'),
			'name' => t('The Sub List Name'),
			'source' => t('Theme Group'),
