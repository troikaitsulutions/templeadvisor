...
class Writeyourreviews extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array(' created,  status, name, parent, email, comments', 'required'),
			...
			array('  name, cr_ip, mod_ip, email ', 'length', 'max'=>255),
			array('id, name, parent, email, comments ', 'safe'),
		);
	}
