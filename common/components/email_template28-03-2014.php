...
function eMailHeader()
{
	...
	<a href="'.FRONT_SITE_URL.'"><img id="logo-img" src="'.FRONT_SITE_URL.'mycms/protected/assets/backend/email/images/CIAO-ITALY-LOGO.png" alt="Ciao Italy Villas Logo" title="Ciao Italy Villas" style="width: 326px;height: 140px;display: block;position: relative;top: 9px;left: 10px;" /></a>
  </div>';
}	
...
function eMailFooter()
{
	return '<div id="civ-footer" style="width: auto;min-height: 160px;padding: 10px;display: block;background-color: #FFF8AF;overflow: hidden;">
			...
			<ul id="civ-sn-icons">
			  <li style="float: left;list-style: none;margin-right: 10px;"><a href="https://www.facebook.com/CiaoItalyVillas" style="text-decoration: none;border: none;outline: none;"><img src="https://www.ciaoitalyvillas.com/mycms/protected/assets/backend/email/images/fb-sn-icon.png" alt="Facebook" title="Facebook" style="width: 60px;height: 60px;outline: none;"></a></li>
			  <li style="float: left;list-style: none;margin-right: 10px;"><a href="http://www.twitter.com/ciaoitalyvillas" style="text-decoration: none;border: none;outline: none;"><img src="https://www.ciaoitalyvillas.com/mycms/protected/assets/backend/email/images/twitter-sn-icon.png" alt="Twitter" title="Twitter" style="width: 60px;height: 60px;outline: none;"></a></li>
			  <li style="float: left;list-style: none;margin-right: 10px;"><a href="http://www.pinterest.com/tuscanvillas" style="text-decoration: none;border: none;outline: none;"><img src="https://www.ciaoitalyvillas.com/mycms/protected/assets/backend/email/images/pinterest-sn-icon.png" alt="Pinterest" title="Pinterest" style="width: 60px;height: 60px;outline: none;"></a></li>
			  <li style="float: left;list-style: none;margin-right: 10px;"><a href="https://plus.google.com/u/0/115223660316741048852" style="text-decoration: none;border: none;outline: none;"><img src="https://www.ciaoitalyvillas.com/mycms/protected/assets/backend/email/images/google-sn-icon.png" alt="Google +" title="Google +" style="width: 60px;height: 60px;outline: none;"></a></li>
			  <li style="float: left;list-style: none;margin-right: 10px;"><a href="https://www.youtube.com/TuscanyTrip" style="text-decoration: none;border: none;outline: none;"><img src="https://www.ciaoitalyvillas.com/mycms/protected/assets/backend/email/images/youtube-sn-icon.png" alt="YouTube" title="YouTube" style="width: 60px;height: 60px;outline: none;"></a></li>
			</ul>
		  </div>';
}	
...
function pdfHeader($prop_id)
{
	...
	return '<div id="header">
		  <div id="tt_title">
			<img src="'.Yii::app()->request->baseUrl.'/protected/assets/backend/pdf/images/logo.png" id="tt_logo-img" style="margin-left:10px;margin-top:0px;" alt="Travel Tuscany Logo" title="Travel Tuscany" />
...
function pdfHeaderFoodWine()
{
	return '<div id="header">
		  <div id="tt_title">
			<img src="'.Yii::app()->request->baseUrl.'/mycms/protected/assets/backend/pdf/images/logo.png" id="tt_logo-img" style="margin-left:10px;margin-top:0px;" alt="Travel Tuscany Logo" title="Travel Tuscany" />
			<h1 >Ciao Italy Villas</h1>
			<h3>Villa Rentals Since 2001</h3>
		  </div>
		</div>';
...
$bookinres= "<div class='package_details' style='border-bottom:#000000 1px solid; padding:10px; font-weight:bold;height:490px'>
	<div class='title' style='color:#FF0000; font-size:18px;'>Package Details</div>
<table width='100%' border='0' cellspacing='0' cellpadding='5'>
  ...
  <tr>
    <td colspan='7' align='left' valign='top'>Extras (Extras to be paid on arrival by cash
      )</td>
    </tr>
  <tr>
    <td align='left' valign='top' colspan='4'>".$addi_label."</td>
    <td colspan='3' align='left' valign='top'>".$other_label."</td>
  </tr>
  <tr>
    <td align='left' valign='top' colspan='4'><table width='45%' border='0' cellspacing='0' cellpadding='0' id='comment_smaller_font' style='font-size:12px; float:right; width:400px '>
      ";
      ...
      <tr>
        <td width='37%'>".$bfindaddname->Additional->name."</td>
          <td width='63%'>".$badditionalcostdata->cost." Euro</td>
        </tr>
      ";}
      $bookinres.="
    </table></td>
        <td colspan='3' align='left' valign='top'><table width='50%' border='0' cellspacing='0' cellpadding='0' id='comment_smaller_font2' style='font-size:12px; float:center; width:550px '>
  ";
          ...
          "
          <tr>
          <td width='54%'>".$bfindaddname1->Additional->name."</td>
            <td width='46%'>".$babaothercostdata->cost." Euro</td>
          </tr>
  ";}
          $bookinres.="
        </table></td>
...
return "<div class='terms' style='border-bottom:#000000 1px solid; padding:8px; font-size:12px'>
	<div class='title' style='color:#FF0000; font-size:18px;'>Terms & Conditions</div>
<p>
