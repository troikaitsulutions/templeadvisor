...
--
-- Table structure for table `tt_session`
--
...
--
-- Dumping data for table `tt_session`
--
...
--
-- Table structure for table `tt_auth_assignment`
--
...
--
-- Dumping data for table `tt_auth_assignment`
--

INSERT INTO `tt_auth_assignment` VALUES('Admin', '1', NULL, 'N;');
INSERT INTO `tt_auth_assignment` VALUES('Reporter', '2', NULL, 'N;');
INSERT INTO `tt_auth_assignment` VALUES('Admin', '7', NULL, 'N;');

-- --------------------------------------------------------

--
-- Table structure for table `tt_auth_item`
--
...
--
-- Dumping data for table `tt_auth_item`
--

INSERT INTO `tt_auth_item` VALUES('Guest', 2, 'Guest', 'return Yii::app()->user->isGuest;', 'N;');
INSERT INTO `tt_auth_item` VALUES('Authenticated', 2, 'Authenticated', 'return !Yii::app()->user->isGuest;', 'N;');
INSERT INTO `tt_auth_item` VALUES('Admin', 2, NULL, NULL, 'N;');
INSERT INTO `tt_auth_item` VALUES('Reporter', 2, 'Reporter', NULL, 'N;');
INSERT INTO `tt_auth_item` VALUES('Besite.*', 1, NULL, NULL, 'N;');
INSERT INTO `tt_auth_item` VALUES('Besite.Index', 0, NULL, NULL, 'N;');
INSERT INTO `tt_auth_item` VALUES('Besite.Error', 0, NULL, NULL, 'N;');
INSERT INTO `tt_auth_item` VALUES('Besite.Login', 0, NULL, NULL, 'N;');
INSERT INTO `tt_auth_item` VALUES('Besite.Logout', 0, NULL, NULL, 'N;');
INSERT INTO `tt_auth_item` VALUES('Editor', 2, 'Editor', NULL, 'N;');

-- --------------------------------------------------------

--
-- Table structure for table `tt_auth_item_child`
--
...
--
-- Dumping data for table `tt_auth_item_child`
--

INSERT INTO `tt_auth_item_child` VALUES('Authenticated', 'Besite.Error');
INSERT INTO `tt_auth_item_child` VALUES('Authenticated', 'Besite.Login');
INSERT INTO `tt_auth_item_child` VALUES('Authenticated', 'Besite.Logout');
INSERT INTO `tt_auth_item_child` VALUES('Guest', 'Besite.Error');
INSERT INTO `tt_auth_item_child` VALUES('Guest', 'Besite.Login');
INSERT INTO `tt_auth_item_child` VALUES('Guest', 'Besite.Logout');
INSERT INTO `tt_auth_item_child` VALUES('Reporter', 'Besite.Error');
INSERT INTO `tt_auth_item_child` VALUES('Reporter', 'Besite.Index');
INSERT INTO `tt_auth_item_child` VALUES('Reporter', 'Besite.Login');
INSERT INTO `tt_auth_item_child` VALUES('Reporter', 'Besite.Logout');

-- --------------------------------------------------------

--
-- Table structure for table `tt_autologin_tokens`
--

CREATE TABLE `tt_autologin_tokens` (
...
--
-- Dumping data for table `tt_autologin_tokens`
--
...
--
-- Table structure for table `tt_block`
--

CREATE TABLE `tt_block` (
...
--
-- Dumping data for table `tt_block`
--

INSERT INTO `tt_block` VALUES(1, 'Logo and Info Block', 'logo_info', 1328776042, 1, 1328776042, 'a:0:{}');
INSERT INTO `tt_block` VALUES(2, 'Introduce Block - This is a simple HTML Block', 'html', 1328778200, 1, 1328863645, 'a:1:{s:4:"html";s:568:"\r\n<h2>About Us &amp; Our Mission</h2>\r\n<p>\r\nLorem ipsum dolor sit amet, consectetur adipiscing elit. Sed at venenatis lacus. Quisque aliquam facilisis augue, et viverra mauris pellentesque sed. Quisque ut nibh at eros commodo auctor nec eu augue. Vivamus dignissim sollicitudin aliquet. Vivamus sed commodo turpis. Fusce tempor euismod accumsan. Nunc non tincidunt dui. Vestibulum bibendum ligula nec enim lobortis et euismod arcu gravida. Aenean blandit turpis id libero varius hendrerit. Nunc vitae malesuada elit. Nam sit amet arcu vel eros commodo euismod.</p>\r\n\r\n";}');
INSERT INTO `tt_block` VALUES(3, 'Footer Block - Just a simple HTML Block', 'html', 1328780295, 1, 1328782216, 'a:1:{s:4:"html";s:474:" <div class="info wide">\r\n        	<h2>Contact Us</h2>\r\n<p>GXC CMS is an open source CMS written on Yii Framework. It has been developed since July 2011 by <a href="http://www.nganhtuan.com">Tuan Nguyen </a> and <a href="http://www.tringuyen.me">Tri Nguyen</a> from <a href="http://www.gxcsolutions.com">GxcSolutions</a>. Happy coding!  </p>\r\n        	<p>We love to talk and share, feel free to contact us at <br /> info@gxcsolutions.com\r\n        	<p>&copy; 2012</p>\r\n</div>";}');
INSERT INTO `tt_block` VALUES(4, 'This is a sample of a content list render Block', 'listview', 1328781868, 1, 1328861471, 'a:2:{s:12:"content_list";a:1:{i:0;s:1:"1";}s:12:"display_type";s:1:"0";}');
INSERT INTO `tt_block` VALUES(5, 'Error Notification Block', 'error_notification', 1328862233, 1, 1328862233, 'a:0:{}');
INSERT INTO `tt_block` VALUES(6, 'Content detail view ', 'content_detail_view', 1328863997, 1, 1328863997, 'a:0:{}');
INSERT INTO `tt_block` VALUES(7, 'Div class clear Both Block', 'html', 1328979146, 1, 1328979146, 'a:1:{s:4:"html";s:30:"<div style="clear:both"></div>";}');


-- --------------------------------------------------------

--
-- Table structure for table `tt_content_list`
--

CREATE TABLE `tt_content_list` (
...
--
-- Dumping data for table `tt_content_list`
--

INSERT INTO `tt_content_list` VALUES(1, 'List of newest articles for the homepage', 'a:9:{s:4:"type";s:1:"2";s:4:"lang";a:1:{i:0;s:1:"0";}s:12:"content_type";a:1:{i:0;s:7:"article";}s:5:"terms";a:1:{i:0;s:1:"0";}s:4:"tags";s:0:"";s:6:"paging";s:1:"0";s:6:"number";s:1:"2";s:8:"criteria";s:1:"1";s:11:"manual_list";a:0:{}}', 1328781851);

-- --------------------------------------------------------

--
-- Table structure for table `tt_language`
--

CREATE TABLE `tt_language` (
...
--
-- Dumping data for table `tt_language`
--

INSERT INTO `tt_language` VALUES(1, 'vi_vn', 'Vietnamese', 0, 1, 'vi');
INSERT INTO `tt_language` VALUES(2, 'en_us', 'English', 0, 1, 'en');

-- --------------------------------------------------------

--
-- Table structure for table `tt_menu`
--
...
--
-- Dumping data for table `tt_menu`
--
...
--
-- Table structure for table `tt_menu_item`
--

CREATE TABLE `tt_menu_item` (
...
--
-- Dumping data for table `tt_menu_item`
--
...
--
-- Table structure for table `tt_object`
--

CREATE TABLE `tt_object` (
...
--
-- Dumping data for table `tt_object`
--
...
--
-- Table structure for table `tt_object_meta`
--

CREATE TABLE `tt_object_meta` (
...
--
-- Dumping data for table `tt_object_meta`
--
...
--
-- Table structure for table `tt_object_resource`
--


CREATE TABLE `tt_object_resource` (
...
--
-- Dumping data for table `tt_object_resource`
--
...
--
-- Table structure for table `tt_object_term`
--

CREATE TABLE `tt_object_term` (
  `object_id` bigint(20) unsigned NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `tt_object_term`
--

INSERT INTO `tt_object_term` VALUES(5, 1);
INSERT INTO `tt_object_term` VALUES(6, 1);


-- --------------------------------------------------------

--
-- Table structure for table `tt_page`
--

CREATE TABLE `tt_page` (
...
--
-- Dumping data for table `tt_page`
--

INSERT INTO `tt_page` VALUES(1, 'home', 'Homepage', 'Homepage', 0, 'default', 'home', 2, '4f3373e0a0648', 1, 'Homepage', 1, 1, 'main');
INSERT INTO `tt_page` VALUES(2, 'Error', 'Error', 'Error Notification', 0, 'default', 'error', 2, '4f34d20be0f79', 1, 'Error Notification', 1, 1, 'empty');
INSERT INTO `tt_page` VALUES(3, 'Post Detail View', 'Post Detail View', 'Post Detail View', 1, 'default', 'post', 2, '4f34da1b41620', 1, 'Post Detail View', 1, 1, 'main');
...
--
-- Table structure for table `tt_page_block`
--

CREATE TABLE `tt_page_block` (
...
--
-- Dumping data for table `tt_page_block`
--

INSERT INTO `tt_page_block` VALUES(1, 4, 2, 1, 1);
INSERT INTO `tt_page_block` VALUES(1, 2, 1, 1, 1);
INSERT INTO `tt_page_block` VALUES(1, 1, 1, 1, 0);
INSERT INTO `tt_page_block` VALUES(1, 7, 3, 1, 1);
INSERT INTO `tt_page_block` VALUES(2, 5, 1, 1, 1);
INSERT INTO `tt_page_block` VALUES(3, 6, 1, 1, 1);
INSERT INTO `tt_page_block` VALUES(3, 1, 1, 1, 0);
INSERT INTO `tt_page_block` VALUES(3, 3, 1, 1, 2);
INSERT INTO `tt_page_block` VALUES(1, 3, 1, 1, 2);
...
--
-- Dumping data for table `tt_rights`
--
...
--
-- Table structure for table `tt_settings`
--
...
--
-- Dumping data for table `tt_settings`
--

INSERT INTO `tt_settings` VALUES(3, 'system', 'support_email', '{{SUPPORT_EMAIL}}');
INSERT INTO `tt_settings` VALUES(5, 'system', 'page_size', 's:2:"10";');
INSERT INTO `tt_settings` VALUES(6, 'system', 'language_number', 's:1:"2";');
INSERT INTO `tt_settings` VALUES(7, 'general', 'site_name', '{{SITE_NAME}}');
INSERT INTO `tt_settings` VALUES(8, 'general', 'site_title', '{{SITE_NAME}}');
INSERT INTO `tt_settings` VALUES(9, 'general', 'site_description', '{{SITE_NAME}}');
INSERT INTO `tt_settings` VALUES(13, 'general', 'homepage', 's:4:"home";');
INSERT INTO `tt_settings` VALUES(14, 'general', 'slogan', '{{SLOGAN}}');
INSERT INTO `tt_settings` VALUES(15, 'general', 'post_link', 's:4:"post";');
INSERT INTO `tt_settings` VALUES(16, 'general', 'error_link', 's:5:"error";');
INSERT INTO `tt_settings` VALUES(17, 'system', 'keep_file_name_upload', 's:1:"0";');
...
--
-- Table structure for table `tt_source_message`
--

CREATE TABLE `tt_source_message` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `tt_source_message`
--
...
--
-- Table structure for table `tt_tag`
--
...
--
-- Table structure for table `tt_tag_relationships`
--

CREATE TABLE `tt_tag_relationships` (
...
--
-- Dumping data for table `tt_tag_relationships`
--


--
-- Table structure for table `tt_taxonomy`
--

CREATE TABLE `tt_taxonomy` (
...
--
-- Dumping data for table `tt_taxonomy`
--

INSERT INTO `tt_taxonomy` VALUES(1, 'Article Categories', 'Article Categories', 'article', 2, '4f336d87ac576');
INSERT INTO `tt_taxonomy` VALUES(2, 'Event Categories', 'Event Categories', 'event', 2, '4f336d99f1482');

-- --------------------------------------------------------

--
-- Table structure for table `tt_term`
--

CREATE TABLE `tt_term` (
...
--
-- Dumping data for table `tt_term`
--

INSERT INTO `tt_term` VALUES(1, 1, 'Uncategories', 'Uncategories', 'uncategories', 0, 1);
INSERT INTO `tt_term` VALUES(2, 2, 'Uncategories', 'Uncategories', 'uncategories-event', 0, 1);


-- --------------------------------------------------------

--
-- Table structure for table `tt_transfer`
--
...
--
-- Dumping data for table `tt_transfer`
--

INSERT INTO `tt_transfer` VALUES(43, 1, 1, 0, 2, 1, 3, NULL, 1328760601);
INSERT INTO `tt_transfer` VALUES(46, 4, 1, 0, 2, 1, 3, NULL, 1328760876);

-- --------------------------------------------------------

--
-- Table structure for table `tt_translated_message`
--

CREATE TABLE `tt_translated_message` (
...
--
-- Dumping data for table `tt_translated_message`
--
...
INSERT INTO `tt_user` VALUES(1, 'admin', 'admin', 'Admin', '{{password}}', '{{password_salt}}', 'admin@localhost.com', NULL, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), '', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 1, NULL);


-- --------------------------------------------------------

--
-- Table structure for table `tt_user_meta`
--

CREATE TABLE `tt_user_meta` (
...
--
-- Dumping data for table `tt_user_meta`
--

-- --------------------------------------------------------

--
-- Table structure for table `tt_resource`
--

CREATE TABLE `tt_resource` (
...
--
-- Dumping data for table `tt_resource`
--
