...
define('FRONT_END',dirname(dirname(__FILE__)).DIRECTORY_SEPARATOR.'protected');
define('FRONT_STORE',dirname(dirname(__FILE__)));
define('BACK_END',dirname(dirname(__FILE__)).DIRECTORY_SEPARATOR.'mycms'.DIRECTORY_SEPARATOR.'protected');
define('BACK_STORE',dirname(dirname(__FILE__)).DIRECTORY_SEPARATOR.'mycms');
