 ...
 *
 */
class PlanyourtripController extends FeController
{
	...
	public function actionIndex()
	{
		...
		$this->render('planyourtrip1',array( 'page'=>$page, 'meta'=>$meta ));
	...
	public function actionBymap()
	{
		...
		$DistrictSearches = District::model()->findAll(array('condition'=>"name LIKE '%".$l."%'"));
		...
		$StateSearches = State::model()->findAll(array('condition'=>"name LIKE '%".$l."%'"));
