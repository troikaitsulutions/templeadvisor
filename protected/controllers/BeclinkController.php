 ...
 *
 */
class BeclinkController extends BeController{
	...
	{                
		...
		$this->render('clink_update',array('id'=>$id));
	}
	...
	{                            
             GxcHelpers::deleteModel('Clink', $id);          
	}
