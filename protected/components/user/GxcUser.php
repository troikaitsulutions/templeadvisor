...
class GxcUser extends CWebUser{
        ...
        */
		...
		public function getisWritter(){
            if($roles=User::getStringRoles(user()->id)!=''){
                $res=strpos('Content Writter',User::getStringRoles(user()->id));
                return (($res!==false));
            } 
            return false;
        }
		...
		public function getisOperator(){
            if($roles=User::getStringRoles(user()->id)!=''){
                $res=strpos('Operator',User::getStringRoles(user()->id));
                return (($res!==false));
            } 
            return false;
        }
		
		public function getisSeo(){
            if($roles=User::getStringRoles(user()->id)!=''){
                $res=strpos('Seo',User::getStringRoles(user()->id));
                return (($res!==false));
            } 
            return false;
        }
		...
		public function getisAgent(){
            if($roles=User::getStringRoles(user()->id)!=''){
                $res=strpos('Travel Agent',User::getStringRoles(user()->id));
                return (($res!==false));
            } 
            return false;
        }
		
		public function getisVillaOwner(){
            if($roles=User::getStringRoles(user()->id)!=''){
                $res=strpos('owners',User::getStringRoles(user()->id));
                return (($res!==false));
            } 
            return false;
        }
