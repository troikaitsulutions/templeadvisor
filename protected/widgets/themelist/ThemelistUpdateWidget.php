 ...
 *
 */
class ThemelistUpdateWidget extends CWidget
{
    ...
    { 
       ...
       $model =  GxcHelpers::loadDetailModel('Themelist', $id);
				...
				$mseo->layout = 'Themelist';
				  ...
				  $valid=$model->validate();
				   ...
				   if($valid)
                    ...
                    user()->setFlash('success',t('Theme Sub list information has been updated Successfully!'));                                                            
                    $model=new Themelist;
