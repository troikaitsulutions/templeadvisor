 ...
 *
 */
class DirectionCreateWidget extends CWidget
{
    ...
    {       
        ...
        if($guid!=''){
                $review_object=  Direction::model()->with('language')->findAll('guid=:gid',array(':gid'=>$guid));
        ...
        if(isset($_POST['Direction']))
        {
                ...
                if($model->save()){           
                    ...
                    user()->setFlash('success',t('The Direction has been Added Successfully!'));                                
                    $model=new Direction;
