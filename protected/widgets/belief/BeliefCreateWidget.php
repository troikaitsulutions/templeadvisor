 ...
 *
 */
class BeliefCreateWidget extends CWidget
{
    ...
    {       
        ...
        if($guid!=''){
                $review_object=  Belief::model()->with('language')->findAll('guid=:gid',array(':gid'=>$guid));
				...
				$model->cr_ip = ip();
				  ...
				  $valid=$model->validate();
				   ...
				   if($valid)
                    ...
                    user()->setFlash('success',t('Belief/Faith Added Successfully!'));                                                            
                    $model=new Belief;
                    Yii::app()->controller->redirect(array('create'));
                } }
        }                
        $this->render('cmswidgets.views.belief.belief_form_widget',array('model'=>$model,'lang_exclude'=>$lang_exclude,'versions'=>$versions));            
    }   
