        ...
        <div class="block-fluid">
         ...
         <div class="row-form">
          ...
          <div class="row-form">
            ...
            <div class="span7"> <?php echo $form->dropDownList($model,'s_type', array('Additional Cost'=>'Additional Cost','Other Service'=>'Other Service'),array('class'=>'box_required')); ?> <span><?php echo $form->error($model,'s_type'); ?> </span> </div>
            <div class="clear"></div>
          </div>
