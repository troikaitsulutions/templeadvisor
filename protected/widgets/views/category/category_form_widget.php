        ...
        <div class="block-fluid">
          <div class="row-form">
            ...
            <div class="span2"> <?php echo $form->dropDownList($model,'status',  ConstantDefine::getPageStatus(),array()); ?> <span><?php echo $form->error($model,'status'); ?></span> </div>
             <div class="span1"></div>
              <div class="span1">
          <button class="btn btn-minimum" type="submit"><?php echo t('Save'); ?></button>  
      </div>
            <div class="clear"></div>
          </div>
...
<?php $this->render('cmswidgets.views.category.category_form_javascript',array('model'=>$model,'form'=>$form)); ?>
