...
?>
    ...
    <div class="row-fluid">
      <div class="span6">
        <div class="head">
          ...
          <h1><?php echo t('Tour Subcategory'); ?></h1>
          <div class="clear"></div>
        </div>
        <div class="block-fluid">
          ...
          <div class="row-form">
            ...
            <div class="span7"> <?php echo $form->dropDownList($model, 'source', Tourcategory::GetAll()); ?> <span><?php echo $form->error($model,'source'); ?> </span> </div>
            <div class="clear"></div>
          </div>
          <div class="row-form">
            ...
            <div style="height:100px;">
              <div style="float:right;"><?php echo CHtml::image(Toursubcategory::GetThumbnail($model->icon_file),$model->name); ?></div>
            </div>
            <?php } ?>
          </div>
          <div class="row-form">
 ...
 <div class="head">
  ...
  <h1><?php echo t('All Tour Subcategory'); ?></h1>
  <div class="clear"></div>
</div>
<div class="block-fluid table-sorting">
  <?php $this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'toursubcategory-grid',
	...
	'columns'=>array(
		...
		array(
			...
			'value'=>'Toursubcategory::GetThumbnail($data->icon_file)',
            'filter'=>false,
			'visible'=>true
		    ),
		...
		array('name'=>'source',
			'type'=>'raw',
			'htmlOptions'=>array('class'=>'gridmaxwidth'),
			'value'=>'Tourcategory::GetName($data->source)',
		    ),
...
<?php $this->render('cmswidgets.views.toursubcategory.toursubcategory_form_javascript',array('model'=>$model,'form'=>$form)); ?>
