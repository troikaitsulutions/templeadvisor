    ...
    <div class="row-fluid">
      <div class="span6">
        ...
        <div class="block-fluid">
            ...
            <div class="block gallery"> <a class="fancybox" rel="group" href="<?php echo Gallery::GetLargeImage($model); ?>"><img src="<?php echo Gallery::GetThumbnail($model); ?>" class="img-polaroid"/></a>
              <div class="clear"></div>
          </div>
        </div>
      </div>
