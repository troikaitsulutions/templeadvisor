        ...
        <div class="block-fluid">
          ...
          <div class="row-form">
            ...
            <div style="height:100px;">
              <div style="float:right;"><?php echo CHtml::image(Productidols::GetThumbnail($model->icon_file),$model->name); ?></div>
            </div>
            <?php } ?>
          </div>
...
{	
		var acost = document.getElementById("Productidols_cost").value;
		var mcost = document.getElementById("Productidols_margin_cost").value;
		var pcost = document.getElementById("Productidols_packing_cost").value;
		var scost = document.getElementById("Productidols_shipping_cost").value;
		var mtype = document.getElementById("Productidols_margin_type").value;
		var tcost = document.getElementById("Productidols_service_tax").value;
		...
		document.getElementById("Productidols_total").value = Math.ceil(gcost/100)*100;
}
