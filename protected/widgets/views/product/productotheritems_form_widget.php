    ...
    <div class="row-fluid">
      <div class="span6">
        <div class="head">
          ...
          <h1><?php echo t('Other Items info');  ?></h1>
          <div class="clear"></div>
        </div>
        <div class="block-fluid">
          ...
          <div class="row-form">
            ...
            <div style="height:100px;">
              <div style="float:right;"><?php echo CHtml::image(Productotheritems::GetThumbnail($model->icon_file),$model->name); ?></div>
            </div>
            <?php } ?>
          </div>
...
{	
		var acost = document.getElementById("Productotheritems_cost").value;
		var mcost = document.getElementById("Productotheritems_margin_cost").value;
		var pcost = document.getElementById("Productotheritems_packing_cost").value;
		var scost = document.getElementById("Productotheritems_shipping_cost").value;
		var mtype = document.getElementById("Productotheritems_margin_type").value;
		var tcost = document.getElementById("Productotheritems_service_tax").value;
		...
		document.getElementById("Productotheritems_total").value = Math.ceil(gcost/100)*100;
}
