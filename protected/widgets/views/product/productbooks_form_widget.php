         ...
         <div class="row-form">
          ...
          <div class="row-form">
            ...
            <div style="height:100px;">
              <div style="float:right;"><?php echo CHtml::image(Productbooks::GetThumbnail($model->icon_file),$model->name); ?></div>
            </div>
            <?php } ?>
          </div>
...
{	
		var acost = document.getElementById("Productbooks_cost").value;
		var mcost = document.getElementById("Productbooks_margin_cost").value;
		var pcost = document.getElementById("Productbooks_packing_cost").value;
		var scost = document.getElementById("Productbooks_shipping_cost").value;
		var mtype = document.getElementById("Productbooks_margin_type").value;
		var tcost = document.getElementById("Productbooks_service_tax").value;
		...
		document.getElementById("Productbooks_total").value = Math.ceil(gcost/100)*100;
}
