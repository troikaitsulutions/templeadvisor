    ...
    <div class="row-fluid">
      <div class="span12">
        <div class="head">
          ...
          <h1><?php echo t('General Enquiry'); ?></h1>
          <div class="clear"></div>
        </div>
        <div class="block-fluid">
          <div class="row-form">
           ...
           <div class="row-form">
            ...
            <div class="span1"><?php echo $form->label($model,'remarks'); ?></div>
            <div class="span4"> <?php echo $form->textArea($model,'remarks',array()); ?> <span><?php echo $form->error($model,'remarks'); ?> </span> </div>
            <div class="clear"></div>
          </div>
          <div class="row-form">
