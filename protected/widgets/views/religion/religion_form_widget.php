        ...
        <div class="block-fluid">
          ...
          <div class="row-form">
            ...
            <div style="height:100px;">
              <div style="float:right;"><?php echo CHtml::image(Religion::GetThumbnail($model->icon_file),$model->name); ?></div>
            </div>
            <?php } ?>
          </div>
          <div class="row-form">
...
<?php $this->render('cmswidgets.views.religion.religion_form_javascript',array('model'=>$model,'form'=>$form)); ?>
