      ...
      <div class="span6">
        ...
        <div class="block-fluid">
          ...
          <div class="row-form">
            ...
            <div class="span7"> <?php echo $form->dropDownList($model, 'source', Diety::GetAll(false), array()); ?> <span><?php echo $form->error($model,'source'); ?> </span> </div>
            <div class="clear"></div>
          </div>
          <div class="row-form">
...
<?php $this->render('cmswidgets.views.avatar.avatar_form_javascript',array('model'=>$model,'form'=>$form)); ?>
