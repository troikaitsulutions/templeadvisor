    ...
    <div class="row-fluid">
      <div class="span6">
        ...
        <div class="block-fluid">
		  ...
		  <div class="row-form">
            <div class="span3"><?php echo $form->label($model,'temple_diety'); ?></div>
            <div class="span3"> <?php echo $form->checkBox($model,'temple_diety',array()); ?>  <span><?php echo $form->error($model,'temple_diety'); ?></span> </div>
            <div class="span3"><?php echo $form->label($model,'pooja_diety'); ?></div>
            <div class="span3"> <?php echo $form->checkBox($model,'pooja_diety',array()); ?>  <span><?php echo $form->error($model,'pooja_diety'); ?></span> </div>
		  ...
		  <div class="row-form">
            ...
            <div class="span9"> <?php echo $form->textArea($model,'comment',array()); ?>  <span><?php echo $form->error($model,'comment'); ?></span> </div>
            <div class="clear"></div>
          </div>
          ...
          <div class="row-form">
            ...
            <div style="height:100px;">
              <div style="float:right;"><?php echo CHtml::image(Diety::GetThumbnail($model->icon_file),$model->name); ?></div>
            </div>
            <?php } ?>
          </div>
  ...
  <?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
		...
		array(
			...
			'value'=>'Diety::GetThumbnail($data->icon_file)',
            'filter'=>false,
			'visible'=>true
		    ),
...
<?php $this->render('cmswidgets.views.diety.diety_form_javascript',array('model'=>$model,'form'=>$form)); ?>
