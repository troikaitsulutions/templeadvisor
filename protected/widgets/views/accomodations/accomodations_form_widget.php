...
?>
    ...
    <div class="row-fluid">
      <div class="span6">
        <div class="head">
          ...
          <h1><?php echo t('Accomodations'); ?></h1>
          <div class="clear"></div>
        </div>
        <div class="block-fluid">
		  ...
		  <div class="row-form">
            <div class="span5"><?php echo $form->label($model,'content'); ?></div>
            <div class="span7"> <?php echo $form->textArea($model, 'content'); ?> <span><?php echo $form->error($model,'content'); ?></span> </div>
            <div class="clear"></div>
          </div>
  ...
  <h1><?php echo t('All Accomodations'); ?></h1>
  <div class="clear"></div>
</div>
