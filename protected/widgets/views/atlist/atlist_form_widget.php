...
?>
  ...
  <div class="row-fluid">
    <div class="span12">
      ...
      <div class="block-fluid">
        ...
        <div class="row-form">
          <div class="span2"><?php echo $form->labelEx($model,'source'); ?></div>
          <div class="span3"> <?php echo $form->dropDownList($model, 'source', Attype::GetAll(false), array()); ?> <span><?php echo $form->error($model,'source'); ?></span> </div>
  ...
  <div class="head">
    ...
    <h1><?php echo t('All Attractions'); ?></h1>
    <div class="clear"></div>
  </div>
  <div class="block-fluid table-sorting">
	...
	array('name'=>'source',
			...
			'value'=>'Attype::GetName($data->source)',
		    ),
		array('name'=>'name',
			'type'=>'raw',
			'htmlOptions'=>array('class'=>'gridmaxwidth'),
