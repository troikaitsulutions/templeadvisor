  ...
  <div class="row-fluid">
    <div class="span12">
      <div class="head">
        ...
        <h1><?php echo t('All Puja Purposes'); ?></h1>
        <div class="clear"></div>
      </div>
...
<?php $this->render('cmswidgets.views.pujapurpose.pujapurpose_form_javascript',array('model'=>$model,'form'=>$form)); ?>  
