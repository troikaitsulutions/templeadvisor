    ...
    <div class="row-fluid">
      <div class="span12">
        ...
        <div class="block-fluid">
          <div class="row-form">
            <?php			
			echo "<h4>Themes</h4> <div class='clear'></div><div class='well'>";
			echo $form->checkBoxList($model,'themelist',CHtml::listData(Themelist::model()->findAll(array("condition"=>"status = 1","order"=>"TRIM(name) ASC")), 'id', 'name'), array('separator'=>'','template'=>'<div class="amenities_display_div"> {input} <div class="amenities_display_label_div">{label}</div></div>'));							
