    ...
    <div class="row-fluid">
      <div class="span12">
        <div class="head">
          ...
          <h1><?php echo t('Product category'); ?></h1>
          <div class="clear"></div>
        </div>
        <div class="block-fluid">
          <div class="row-form">
            <div class="span2"><?php echo $form->label($model,'name'); ?></div>
            <div class="span3"> <?php echo $form->textField($model, 'name',array('id'=>'txt_name')); ?> <span><?php echo $form->error($model,'name'); ?> </span></div>
          ...
          <div class="span2"><?php echo $form->label($model,'comment'); ?></div>
            <div class="span3"> <?php echo $form->textArea($model, 'comment'); ?> <span><?php echo $form->error($model,'comment'); ?> </span></div>
           
            <div class="span1"><?php echo $form->label($model,'icon_file'); ?></div>
            <div class="span3"> <?php echo $form->fileField($model, 'icon_file');?> <span><?php echo $form->error($model,'icon_file'); ?> </span></div>
            <div class="clear"></div>
            <?php if($model->icon_file!=''){?>
            <div style="height:100px;">
              <div style="float:right;"><?php echo CHtml::image(Tcategory::GetThumbnail($model->icon_file),$model->name); ?></div>
            </div>
            <?php } ?>
          </div>
  ...
  <div class="block-fluid table-sorting">
	...
	'columns'=>array(
		...
		array(
			...
			'value'=>'Tcategory::GetThumbnail($data->icon_file)',
            'filter'=>false,
			'visible'=>true
		    ),
		array('name'=>'name',
