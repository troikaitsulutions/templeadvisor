  ...
  <div class="row-fluid">
    <div class="span6">
      <div class="head">
        ...
        <h1><?php echo Temples::getPageName($model->prop_id);  ?></h1>
        <div class="clear"></div>
      </div>
      <div class="block-fluid">
        <div class="row-form">
          <div class="span5"><?php echo $form->label($model,'vehicle'); ?></div>
          <div class="span5"> <?php echo $form->dropDownList($model, 'vehicle',Vehicles::GetAll()); ?> <span><?php echo $form->error($model,'vehicle'); ?></span> </div>
          <div class="clear"></div>
        </div>
        <div class="row-form">
        ...
        <div class="row-form">
          <div class="span5"><?php echo $form->label($model,'travel_time'); ?></div>
          <div class="span5"> <?php echo $form->textField($model, 'travel_time'); ?> <span><?php echo $form->error($model,'travel_time'); ?></span> </div>
          <div class="clear"></div>
        </div>
        <div class="row-form">
