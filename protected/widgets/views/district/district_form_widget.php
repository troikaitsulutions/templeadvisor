      ...
      <div class="span6">
        ...
        <div class="block-fluid">
          ...
          <div class="row-form">
            ...
            <div class="span7"> <?php echo $form->dropDownList($model, 'source', State::GetAll(false), array()); ?> <span><?php echo $form->error($model,'source'); ?> </span> </div>
            <div class="clear"></div>
          </div>
...
<?php $this->render('cmswidgets.views.district.district_form_javascript',array('model'=>$model,'form'=>$form)); ?>
