 ...
 *
 */
class ThemesUpdateWidget extends CWidget
{
    ...
    { 
       ...
       $model =  GxcHelpers::loadDetailModel('Themes', $id);
				...
				if( isset($IconFile) ) {
				  ...
				  $valid=$model->validate();
				   ...
				   if($valid)
                    ...
                    user()->setFlash('success',t('Themes information has been updated Successfully!'));                                                            
                    $model=new Themes;
