 ...
 *
 */
class PujapurposeCreateWidget extends CWidget
{
    ...
    {       
        ...
        if(isset($_POST['Pujapurpose'], $_POST['Seo']))
        {
                $model->attributes=$_POST['Pujapurpose'];  
				   ...
				   if($valid)
        			{
                		if($model->save() && $mseo->save() ){           
                    		user()->setFlash('success',t('Puja Purpose Added Successfully!'));                                                            
                    		$model=new Pujapurpose;
                    		Yii::app()->controller->redirect(array('create'));
                } }
        }                
        $this->render('cmswidgets.views.pujapurpose.pujapurpose_form_widget',array('model'=>$model,'mseo'=>$mseo));            
    }   
	
	protected function performAjaxValidation($models)
	{
    	if(isset($_POST['ajax']) && $_POST['ajax']==='pujapurpose-form')
        {
