 ...
 *
 */
class EventsCreateWidget extends CWidget
{
    ...
    {       
        ...
        if($guid!=''){
                $review_object=  Events::model()->with('language')->findAll('guid=:gid',array(':gid'=>$guid));
        ...
        if(isset($_POST['Events']))
        {
                ...
                if($model->save()){           
                    ...
                    user()->setFlash('success',t('The Event has been Added Successfully!'));                                
                    $model=new Events;
