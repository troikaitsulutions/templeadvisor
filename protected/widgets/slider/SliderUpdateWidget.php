 ...
 *
 */
class SliderUpdateWidget extends CWidget
{
    ...
    {       
        ...
        $model=  GxcHelpers::loadDetailModel('Slider', $id);
        ...
        $this->render('cmswidgets.views.slider.slider_edit_widget',array('model'=>$model,'lang_exclude'=>$lang_exclude,'versions'=>$versions));            
