 ...
 *
 */
class AvatarCreateWidget extends CWidget
{
    ...
    {       
        ...
        if($guid!=''){
                $review_object=  Avatar::model()->with('language')->findAll('guid=:gid',array(':gid'=>$guid));
				...
				$mseo->layout = 'avatar';
				  ...
				  $valid=$model->validate();
				   ...
				   if($valid)
                    ...
                    user()->setFlash('success',t('Avatar Added Successfully!'));                                                            
                    $model=new Avatar;
                    Yii::app()->controller->redirect(array('admin'));
                } }
        }                
        $this->render('cmswidgets.views.avatar.avatar_form_widget',array('model'=>$model,'mseo'=>$mseo,'lang_exclude'=>$lang_exclude,'versions'=>$versions));            
    }   
