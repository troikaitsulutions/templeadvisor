 ...
 *
 */
class OtherservicesCreateWidget extends CWidget
{
    ...
    {       
        ...
        if($guid!=''){
                $review_object=  Otherservices::model()->with('language')->findAll('guid=:gid',array(':gid'=>$guid));
        ...
        if(isset($_POST['ajax']) && $_POST['ajax']==='other-services-form')
        {
        ...
        if(isset($_POST['Otherservices']))
        {
                ...
                if($model->save()){           
                    ...
                    user()->setFlash('success',t('The Other Services has been Added Successfully!'));                                
        ...
        $this->render('cmswidgets.views.otherservices.other_services_create_form_widget',array('model'=>$model,'lang_exclude'=>$lang_exclude,'versions'=>$versions));
    }   
}
