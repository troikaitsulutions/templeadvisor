...
/**
 * This is the model class for table "tt_plocation".
 *
 * The followings are the available columns in table 'tt_plocation':
 * @property string $id
 * @property string $uid
 ...
 */
class TtPlocation extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return TtPlocation the static model class
	 */
