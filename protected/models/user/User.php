...
class User extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
                        array('salt,created_time, updated_time, recent_login, confirmed,twitteruid, people_type, people_id, docs','safe'),
			array('username, display_name, email, password, people_type, people_id', 'required'),
	...
	public function relations()
	{
		...
		return array(
			'People' => array(self::HAS_ONE, 'People', '', 'on'=>'People.id = User.people_id'),
		);
	}
	...
	public static function getStringRoles($uid=0)
	{
        ...
        public static function convertUserApprovalState($data)
		{               
	                 $image= ($data->mstatus==ConstantDefine::USER_STATUS_ACTIVE) ? 'active' : 'disabled';
		...
		{               
			 if($data->avatar) return CHtml::image(Yii::app()->baseUrl.'/../avatar/'.$data->avatar,'',array('width'=>100,'height'=>100));  
		}
        ...
        public static function findPeople($keyword,$limit=20){            
		 ...
		 public static function GetUserName( $id ){    
			...
			if($UserName) { return $UserName->display_name; } else { return ""; }
        }
		
		public static function GetUserEmail( $id ){    
		         
            $UserName = User::model()->findByPk( $id );
			if($UserName) { return $UserName->email; } else { return ""; }
        }
