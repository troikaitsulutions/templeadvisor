...
tjq(window).load(function() {
    ...
    if (enableChaser == 1 && tjq('#content').length > 0 && tjq('#main-menu ul.menu').length > 0) {
        ...
        tjq('<h1 class="logo navbar-brand"><a title="Temple Advisor" href="/"><img alt="Temple Advisor" src="http://staging.templeadvisor.com/resources/logo-new.jpg"></a></h1>').insertBefore('.chaser .menu');
	...
	// filters option
    tjq(".sort-by-section .block-sm a").click(function(e) {
        e.preventDefault();
        if (tjq(this).parent().hasClass("active")) {
            tjq(this).parent().removeClass("active");
        } else {
